      ...
      <div class="footer-left">
        ...
        <div class="footer-left__blocks">
          ...
          <div v-if="company.emails && company.emails.length" class="footer-left__block">
            <span class="footer-left__block-title">{{ $t("Email") }}</span>
            <span class="footer-left__block-description">
          ...
          <div v-if="company.phones && company.phones.length" class="footer-left__block">
            <span class="footer-left__block-title">{{ $t("Phones") }}</span>
            <span class="footer-left__block-description">
      ...
      <div class="footer-right">
        <div class="footer-columns">
          <div class="footer-column">
            <span class="footer-column__title">{{ $t("Links") }}</span>
          ...
          <div v-if="pages && pages.length" class="footer-column">
            <span class="footer-column__title">{{ $t("Terms") }}</span>
            <ul class="footer-column__links">
