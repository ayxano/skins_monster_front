<template>
  <section class="stats" data-v-3cc6f55e="" data-v-3dcb86c7="">
    <div class="base-dot-pattern stats-dots stats-dots--left" style="--dot-color:#302e2a;" data-v-44941d30=""
      data-v-3cc6f55e=""></div>
    <div data-id="support" class="stats-item in-viewport" data-v-2aea18ba="" data-v-3cc6f55e="">
      <!-- <svg aria-hidden="true"
        focusable="false" data-prefix="fat" data-icon="messages-question" role="img" xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 640 512" class="stats-item__icon svg-inline--fa fa-messages-question fa-fw" data-v-2aea18ba="">
        <path fill="currentColor"
          d="M208 233.2c-6.299 0-11.41 5.105-11.41 11.41C196.6 250.9 201.7 256 208 256s11.41-5.107 11.41-11.41C219.4 238.3 214.3 233.2 208 233.2zM228.7 72H183.3C159.4 72 140 91.38 140 115.2c0 4.422 3.578 8 8 8s8-3.578 8-8C156 100.2 168.3 88 183.3 88h45.44C245.1 88 260 101.1 260 119.2c0 11.88-6.625 22.55-17.38 27.91L204.3 166.9C201.7 168.3 200 171 200 174V200c0 4.422 3.578 8 8 8s8-3.578 8-8V178.9l33.86-17.53C265.1 153.3 276 137.1 276 119.2C276 93.16 254.8 72 228.7 72zM576 128H472c-4.418 0-8 3.582-8 8s3.582 8 8 8H576c26.51 0 48 21.49 48 48v191.1c0 26.51-21.49 47.1-47.99 47.1H528v57.74l-76.91-57.74H320c-26.51 0-48-21.49-48-48v-7.971c0-4.418-3.582-8-8-8s-8 3.582-8 8v7.983c0 35.2 28.8 63.1 63.1 63.1l125.8-.0073l82.75 62.12C530.3 511.4 532.3 512 534.2 512C539.2 512 544 507.1 544 502.2v-54.24h32c35.2 0 64-28.8 64-63.1V191.1C640 156.8 611.2 128 576 128zM352 319.9c35.15 0 64-28.75 64-63.92V63.1C416 28.75 387.3 0 352 0H64C28.75 0 0 28.75 0 63.1v192C0 291.2 28.75 320 64 320l32 .0106v54.25C96 380 100.8 384.1 105.8 384.1c1.941 0 3.926-.5977 5.699-1.918l82.75-62.12L352 319.9zM194.2 304L188.9 304L112 361.8V304L64 304c-26.47 0-48-21.53-48-47.1V63.99C16 37.53 37.53 16 64 16h288c26.47 0 48 21.53 48 47.99v192c0 26.4-21.43 47.87-48.01 47.87L194.2 304z"
          data-v-2aea18ba="" class=""></path>
      </svg>  -->
      <span class="stats-item__value" data-v-2aea18ba="">24/7</span> <span class="stats-item__label"
        data-v-2aea18ba="">Support</span></div>
    <div data-id="items" class="stats-item in-viewport" data-v-2aea18ba="" data-v-3cc6f55e="">
      <!-- <svg aria-hidden="true"
        focusable="false" data-prefix="fat" data-icon="box-open" role="img" xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 640 512" class="stats-item__icon svg-inline--fa fa-box-open fa-fw" data-v-2aea18ba="">
        <path fill="currentColor"
      ...
      <span class="stats-item__value" data-v-2aea18ba="">16,571</span> <span class="stats-item__label"
        data-v-2aea18ba="">Available Items</span></div>
    <div data-id="trades" class="stats-item in-viewport" data-v-2aea18ba="" data-v-3cc6f55e="">
      <!-- <svg aria-hidden="true"
        focusable="false" data-prefix="fat" data-icon="shield-check" role="img" xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512" class="stats-item__icon svg-inline--fa fa-shield-check fa-fw" data-v-2aea18ba="">
        <path fill="currentColor"
          d="M466.5 83.71l-192-80c-4.875-2.031-13.16-3.703-18.44-3.703c-5.312 0-13.55 1.672-18.46 3.703L45.61 83.71C27.7 91.1 16 108.6 16 127.1C16 385.2 205.2 512 255.9 512C307.1 512 496 383.8 496 127.1C496 108.6 484.3 91.1 466.5 83.71zM255.1 496C212.1 496 32 374 32 127.1c0-12.99 7.734-24.57 19.75-29.54l191.1-79.1C246.7 17.21 252.8 16 256.1 16c3.188 0 9.383 1.234 12.29 2.441l192 80.02C472.3 103.4 480 114.1 480 127.1C480 405.6 270.9 496 255.1 496zM360.1 175.1c-2.128 0-4.242 .8459-5.8 2.509L224.2 316.2L158 242.6C156.4 240.9 154.3 239.1 152.1 239.1c-4.49 0-7.995 3.675-7.995 8.02c0 1.905 .6777 3.817 2.058 5.35l72 80c1.531 1.672 4 2.156 5.938 2.641c2.188 0 4.312-.9062 5.812-2.5l136-144c1.463-1.553 2.19-3.535 2.19-5.512C368.1 179 363.9 175.1 360.1 175.1z"
          data-v-2aea18ba="" class=""></path>
      </svg>  -->
      <span class="stats-item__value" data-v-2aea18ba="">1,250,000+</span> <span class="stats-item__label"
        data-v-2aea18ba="">Completed Trades</span></div>
    <div data-id="users" class="stats-item in-viewport" data-v-2aea18ba="" data-v-3cc6f55e="">
      <!-- <svg aria-hidden="true"
        focusable="false" data-prefix="fat" data-icon="monkey" role="img" xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 576 512" class="stats-item__icon svg-inline--fa fa-monkey fa-fw" data-v-2aea18ba="">
        <path fill="currentColor"
      ...
      <span class="stats-item__value" data-v-2aea18ba="">100%</span> <span class="stats-item__label"
        data-v-2aea18ba="">Secure payments</span></div>
    <div class="base-dot-pattern stats-dots stats-dots--right" style="--dot-color:#302e2a;" data-v-44941d30=""
      data-v-3cc6f55e=""></div>
  </section>
</template>
...
.base-dot-pattern[data-v-44941d30] {
    background: radial-gradient(circle at center,var(--main) 25%,hsla(0,0%,100%,0) 25%),hsla(0,0%,100%,0);
