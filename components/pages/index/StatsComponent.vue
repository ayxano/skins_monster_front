<template>
  <section class="stats" data-v-3cc6f55e="" data-v-3dcb86c7="">
    <div
      class="base-dot-pattern stats-dots stats-dots--left"
    ...
    <div data-id="support" class="stats-item in-viewport" data-v-2aea18ba="" data-v-3cc6f55e="">
      ...
      <span class="stats-item__value" data-v-2aea18ba="">24/7</span>
      <span class="stats-item__label" data-v-2aea18ba="">{{ $t("Support") }}</span>
    </div>
    <div data-id="items" class="stats-item in-viewport" data-v-2aea18ba="" data-v-3cc6f55e="">
      ...
      <span class="stats-item__value" data-v-2aea18ba="">16,571</span>
      <span class="stats-item__label" data-v-2aea18ba="">{{ $t("Available Items") }}</span>
    </div>
    <div data-id="trades" class="stats-item in-viewport" data-v-2aea18ba="" data-v-3cc6f55e="">
      ...
      <span class="stats-item__value" data-v-2aea18ba="">1,250,000+</span>
      <span class="stats-item__label" data-v-2aea18ba="">{{ $t("Completed Trades") }}</span>
    </div>
    <div data-id="users" class="stats-item in-viewport" data-v-2aea18ba="" data-v-3cc6f55e="">
      ...
      <span class="stats-item__value" data-v-2aea18ba="">100%</span>
      <span class="stats-item__label" data-v-2aea18ba="">{{ $t("Secure payments") }}</span>
    </div>
    <div
      class="base-dot-pattern stats-dots stats-dots--right"
      style="--dot-color: #302e2a"
      data-v-44941d30=""
      data-v-3cc6f55e=""
    ></div>
